        ...
        <!-- DataTales Example -->
          <div class="card shadow mb-4">
            ...
            <?php
                include 'koneksi.php';
                $nip = $_GET['nip'];
                $data = mysqli_query($connect,"select * from t_pegawai where nip='$nip'");
                while($d = mysqli_fetch_array($data)){
            ?>
            <form class="user" action="proses_ubah_pegawai.php" method="post">
              <br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control form-control-user" name="nama" placeholder="NAMA...." required value="<?php echo $d['nama'] ?>">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="date" class="form-control form-control-user" name="tanggal_lahir" placeholder="TANGGAL LAHIR...." required value="<?php echo $d['tanggal_lahir'] ?>">
                    </div>
