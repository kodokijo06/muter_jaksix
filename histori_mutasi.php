        ...
        <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">HISTORI MUTASI</h6>
            </div>
          <form class="user" action="histori_mutasi_isi.php" method="post">
            <br>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="submit" class="btn btn-primary btn-user btn-block" value="Tampilkan">
                </div>
