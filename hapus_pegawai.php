        ...
        <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">HAPUS PEGAWAI</h6>
            </div>
            <?php
                include 'koneksi.php';
                $nip = $_GET['nip'];
                $data = mysqli_query($connect,"select a.nip,a.nama,a.tanggal_lahir,b.keterangan from t_pegawai a left join t_status_kawin b on a.status_kawin=b.kode where nip='$nip'");
                while($d = mysqli_fetch_array($data)){
            ?>
            <form class="user" action="proses_hapus_pegawai.php" method="post">
              <br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control form-control-user" name="nama" placeholder="NAMA...." value="<?php echo $d['nama'] ?>" readonly required>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="date" class="form-control form-control-user" name="tanggal_lahir" placeholder="TANGGAL LAHIR...." value="<?php echo $d['tanggal_lahir'] ?>" readonly required>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">                    
                    <input class="form-control form-control-user" name="status_kawin" value="<?php echo $d['keterangan'] ?>" readonly required>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                    <a href="pegawai.php" class="btn btn-danger btn-user btn-block">Batal</a>
                    </div>
