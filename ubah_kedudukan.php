        ...
        <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">CATAT PINDAH KEDUDUKAN DAN SEKSI</h6>
            </div>
            <?php
                include 'koneksi.php';
                $nip = $_GET['nip'];
                $data = mysqli_query($connect,"select * from t_kedudukan where nip='$nip' and aktif = '1'");
                while($d = mysqli_fetch_array($data)){
            ?>
          <form class="user" action="proses_ubah_kedudukan.php" method="post">
            <br>
