        ...
        <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">UBAH JPM</h6>
            </div>
            <?php
                include 'koneksi.php';
                $nip = $_GET['nip'];
                $kode_jpm = $_GET['jpm'];
                $data = mysqli_query($connect,"select a.nip,a.jpm,b.nama,c.keterangan,a.nilai from t_jpm a left join t_pegawai b on a.nip=b.nip left join t_ref_jpm c on a.jpm=c.kode where a.nip='$nip' and a.jpm='$kode_jpm'");
                while($d = mysqli_fetch_array($data)){
            ?>
        <form class="user" action="proses_hapus_jpm.php" method="post">
          <br>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-8">
              <input type="text" class="form-control form-control-user" name="jpm" placeholder="JPM...." value="<?php echo $d['keterangan'] ?>" required readonly>
              <input type="hidden" value="<?php echo $d['jpm'] ?>" name="kode_jpm">
              </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-8">
              <input type="number" step ="0.01" min ="0" class="form-control form-control-user" name="nilai" placeholder="NILAI...." value="<?php echo $d['nilai'] ?>" required readonly>
              </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-4">
              <input type="submit" value="Hapus" class="btn btn-primary btn-user btn-block">
              </div>
