        ...
        <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">HAPUS SERTIFIKAT</h6>
            </div>
            <?php
                include 'koneksi.php';
                $id = $_GET['id'];
                $data = mysqli_query($connect,"select b.nip,a.nama,c.keterangan,b.nama_file,b.id from t_sertifikat b left join t_pegawai a on a.nip=b.nip left join t_seksi c on b.seksi=c.kode where id = '$id'");
                while($d = mysqli_fetch_array($data)){
            ?>
            <form class="user" action="proses_hapus_sertifikat.php" method="post">
              <br>
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control form-control-user" name="nip" placeholder="NIP...." value="<?php echo $d['nip'] ?>" readonly required>
                </input>
              </div>
          ...
          <div class="form-group row" hidden>
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control form-control-user" name="id" placeholder="ID...." value="<?php echo $d['id'] ?>" readonly required>
                </input>
              </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control form-control-user" name="seksi" placeholder="SEKSI...." value="<?php echo $d['keterangan'] ?>" readonly required>
                </input>
              </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-8">
              <input type="text" class="form-control form-control-user" name="nama_file" placeholder="UPLOAD FILE...." value="<?php echo $d['nama_file'] ?>" readonly required>
              </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-4">
              <a href="sertifikat.php" class="btn btn-danger btn-user btn-block">Batal</a>
              </div>
