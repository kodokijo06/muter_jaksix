        ...
        <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">HAPUS MINAT</h6>
            </div>
            <?php
                include 'koneksi.php';
                $nip = $_GET['nip'];
                $data = mysqli_query($connect,"select a.nip,b.nama,c.keterangan from t_minat a left join t_pegawai b on a.nip=b.nip left join t_seksi c on a.seksi=c.kode where a.nip='$nip'");
                while($d = mysqli_fetch_array($data)){
            ?>
          <form class="user" action="proses_hapus_minat.php" method="post">
            <br>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" class="form-control form-control-user" name="seksi" placeholder="SEKSI...." value="<?php echo $d['keterangan'] ?>" required readonly>
                </div>
