        ...
        <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">UBAH SERTIFIKAT</h6>
            </div>
            <?php
                include 'koneksi.php';
                $id = $_GET['id'];
            ...
            ?>
            <form class="user" action="proses_ubah_sertifikat.php" method="POST" enctype="multipart/form-data">
              <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control form-control-user" name="nip" placeholder="NIP...." maxlength="18" value="<?php echo $d['nip'] ?>" readonly required>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control form-control-user" name="nama" placeholder="NAMA...." required value="<?php echo $d['nama'] ?>" readonly>
                    </div>
